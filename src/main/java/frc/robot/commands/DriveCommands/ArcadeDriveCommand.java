...
public class ArcadeDriveCommand extends CommandBase {
	 ...
	 */
	public ArcadeDriveCommand(ArduinoSubsystem arduinoSubsystem, DriveSubsystem driveSubsystem, Supplier<Double> speedStraight, Supplier<Double> speedLeft,
	...
	public void execute() {
		...
		m_arduinoSubsystem.setMainLEDMode(MainLEDModes.kChasing);
        m_arduinoSubsystem.setMainLEDValue(1);
	}
}