...
public class LimelightDistanceCommand extends CommandBase {
    ...
    public LimelightDistanceCommand(LimelightSubsystem limelightSubsystem, DriveSubsystem driveSubsystem,
    ...
    public void execute() {5
        double verticalAngle = m_limelightSubsystem.getYAngle();
