...
'may be needed to get screen size right, uncomment next line if that's necessary(wherever it's built on the computer)
'fullJarPath = "C:\\Users\\jwaters\\Downloads\\shuffleboard-main\\shuffleboard-main\\app\build\\libs\\Shuffleboard-win64.jar"
...
If (runObj.Status <> 0) Then
	...
	WScript.Quit(2)
End If
Set runObj2 = objShell.Exec("pythonw "+ fso.BuildPath(toolsFolder,"shuffleboardtk.py"))
set rubObj2 = Nothing
Set runObj = Nothing
Set objShell = Nothing
Set fso = Nothing
